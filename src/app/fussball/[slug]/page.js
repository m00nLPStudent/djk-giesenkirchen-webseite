...
export default async function TeamPage({ params }) {
  ...
  const formattedPhone = team?.contact_phone
    ? `+${team.contact_phone.slice(0, 2)} ${team.contact_phone.slice(2, 6)} ${team.contact_phone.slice(6)}`
    : "";
          ...
          {team?.team_image_url && (
            <div className="relative mb-10 overflow-hidden rounded-3xl border border-white/10">
              ...
              <div className="absolute bottom-10 left-10">
                ...
                <h1 className="mt-2 text-7xl font-black">E1 Jugend</h1>
          ...
          <div className="mt-10 rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <div>
                ...
                <p className="mt-2 text-lg">Dienstag & Donnerstag</p>

                <p className="text-white/60">17:00 - 18:45 Uhr</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-lg">16:50 Uhr</p>
              </div>
                ...
                {team?.contact_email && (
                  <div className="flex flex-col gap-4 border-t border-white/10 pt-6 md:flex-row md:items-center md:justify-between">
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 rounded-full border border-white/10 px-6 py-3 font-bold text-white transition hover:border-red-500"
                    >
                      <FaEnvelope size={20} />
                      E-Mail schreiben
                    </a>
                  ...
                  <div className="flex flex-col gap-4 border-t border-white/10 pt-6 md:flex-row md:items-center md:justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-white/50">Anrufen</p>
                      </div>
                    </div>
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 rounded-full bg-green-600 px-6 py-3 font-bold text-white transition hover:bg-green-700"
                    >
                      <FaWhatsapp size={20} />
                      WhatsApp schreiben
                    </a>
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-white/60">{coach.role_de}</p>
                    </div>
                  </div>
                </div>
              ))}
