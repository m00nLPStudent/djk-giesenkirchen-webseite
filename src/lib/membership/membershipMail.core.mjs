...
export async function executeMembershipRequestConfirmation(request = {}, { send, markSent, now = () => new Date().toISOString(), siteUrl = null } = {}) {
  ...
  const content = buildMembershipRequestReceivedMail(request, { siteUrl });
