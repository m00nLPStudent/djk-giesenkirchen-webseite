...
export default function AdminMediaPicker({ value, legacyUrl, placeholderUrl, onChange, loadAction, uploadAction, usageContext = "coach", entityLabel = "Trainerbild" }) {
  ...
  return <div className="grid gap-5 md:grid-cols-[180px_1fr] md:items-center">
    ...
    <AdminMediaPickerDialog open={open} onClose={()=>setOpen(false)} onSelect={onChange} loadAction={loadAction} uploadAction={uploadAction} usageContext={usageContext}/>
  </div>;
}
