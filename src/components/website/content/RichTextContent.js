...
export default function RichTextContent({
  ...
  richTextClassName = "news-richtext-content space-y-4 [&_h2]:text-2xl [&_h2]:font-black [&_h2]:text-white [&_h3]:text-xl [&_h3]:font-bold [&_h3]:text-white [&_img]:h-auto [&_img]:max-w-full [&_img]:rounded-2xl [&_ol]:list-decimal [&_ol]:space-y-2 [&_ol]:pl-6 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-6 [&_p]:text-base [&_p]:leading-8 md:[&_p]:text-lg md:[&_p]:leading-9 [&_strong]:font-bold [&_a]:underline [&_a]:decoration-red-400 [&_a]:underline-offset-4 hover:[&_a]:text-red-300",
}) {
