-- B13.4B guarded safe backfill execution
-- DRY-RUN VERIFIED
-- EXPECTED MUTATIONS: 3
-- IMPORTANT:
-- 1) Run first with ROLLBACK (replace COMMIT with ROLLBACK at the end for test mode).
-- 2) Switch to COMMIT only after reviewing outputs and checks.
-- 3) Backup required before execution.
-- 4) Do not run multiple times.
--
-- Allowed statements in this file:
-- SELECT, WITH, INSERT, UPDATE, BEGIN, COMMIT, PL/pgSQL DO/RAISE EXCEPTION.
...
BEGIN
  ...
  -- ==================================================
  -- In-transaction postchecks before COMMIT
  -- ==================================================
...
-- ========================= CONTROL POINT =========================
-- Test mode: replace COMMIT with ROLLBACK below.
-- Productive mode: keep COMMIT only after validating outputs and checks.
-- ================================================================
COMMIT;
