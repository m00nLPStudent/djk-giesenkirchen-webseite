...
B15.24A–G sowie die reinen Reviewblöcke K und M sind abgeschlossen. Der aktuelle Fußballbereich ist als geliefert akzeptiert: Mannschaftsseiten, integrierte Kader, Trainer/Ansprechpartner und Trainingszeiten bleiben bestehen; neue eigenständige Spielerprofile und eine separate Fußballchronik sind nicht vorgesehen. FUSSBALL.DE-Widgets für Spielpläne, Ergebnisse und Tabellen sind bis zur finalen registrierten Produktivdomain als Go-live-Aufgabe blockiert. Der vollständige Ausbau von Turniere & Events bleibt Future/Post-Go-live. B15.24H1 ist **COMPLETE – TABLE TENNIS DB FOUNDATION AND SECURITY HARDENING VERIFIED**: Live-Preflight, DB-Proposal, vollständiger Read-only-Postcheck und Security-Korrektur-Postcheck sind manuell bestanden. Abteilung, Rolle, Permissions, Department-Scopes, RLS, Active-only-Public-Reads und Helper-ACLs sind live bestätigt. B15.24H bleibt offen; nächster Block ist B15.24H2 – Tischtennis-Dashboard mit strikt auf `tischtennis` begrenzten Mannschafts-, Kader-, Trainer-, Trainingszeiten- und Vorstandspfaden sowie kontrollierten server-only Player-/Coach-Master-Writes. I/J sowie L bleiben offen.
